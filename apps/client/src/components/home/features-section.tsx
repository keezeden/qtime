...
export function FeaturesSection() {
  return (
    <section className="space-y-12 px-6 py-24 md:px-20">
      <h2 className="rotate-1 font-display text-5xl font-black uppercase italic text-[#26fedc]">
        Game Features
      </h2>
        ...
        <div className="group flex rotate-1 flex-col justify-between border-b-8 border-[#ff2bef] bg-[#ff89ab] p-10 shadow-[8px_8px_0px_0px_#1c2028] transition-transform hover:-rotate-1 md:col-span-5">
          ...
          <div className="mt-8">
            ...
            <p className="text-lg font-semibold text-[rgb(89,0,83,0.8)]">
              Personalize your board, flex rare tile skins, and make every duel look like your own
              loud little arena.
            </p>
          </div>
        </div>
