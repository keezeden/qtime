export function CtaSection() {
  return (
    <section className="px-6 py-24 md:px-20">
      <div className="relative overflow-hidden border-b-[12px] border-black bg-[#11141b] p-12 text-center shadow-[12px_12px_0px_0px_#1c2028] md:p-20">
        <div className="relative z-10 space-y-8">
          <h2 className="font-display text-6xl font-black uppercase tracking-tighter text-white italic drop-shadow-lg md:text-8xl">
            Ready To Rumble?
          </h2>
